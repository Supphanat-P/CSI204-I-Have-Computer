...
1. Persona สำหรับกลุ่ม: ลูกค้า (Customer)
ชื่อ-นามสกุล: นายกิตติภพ (นนท์) อายุ 21 ปี
...
2. Persona สำหรับกลุ่ม: ผู้ดูแลระบบ (Administrator)
ชื่อ-นามสกุล: นายอภิสิทธิ์ (เก่ง) อายุ 28 ปี

อาชีพ: เจ้าหน้าที่ไอทีและผู้ดูแลระบบ (IT Support & Admin)

บริบทและพฤติกรรม: เก่งมีความเชี่ยวชาญด้านคอมพิวเตอร์และระบบหลังบ้าน หน้าที่หลักของเขาคือการดูแลความเรียบร้อยของเว็บไซต์ และคอยอัปเดตข้อมูลสินค้าทุกครั้งที่มีโมเดลใหม่ๆ หรืออุปกรณ์ไอทีล็อตใหม่เข้ามาในคลัง
...
3. Persona สำหรับกลุ่ม: ผู้จัดการ (Manager)
ชื่อ-นามสกุล: คุณสมศักดิ์ อายุ 45 ปี
